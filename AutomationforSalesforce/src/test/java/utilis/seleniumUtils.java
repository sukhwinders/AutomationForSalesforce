...
public class seleniumUtils {
	...
	*/
	    ...
	    public void waitForElement(WebDriver driver, int numberOfSeconds, String elementLocator) {
		WebDriverWait waiting = new WebDriverWait(driver, numberOfSeconds);
		waiting.until(ExpectedConditions.presenceOfElementLocated(By.xpath(elementLocator)));
	    }

	/*    public void waitForElement1(WebDriver driver, int numberOfSeconds,String elementLocator) {
		WebDriverWait waiting = new WebDriverWait(driver, numberOfSeconds);
		waiting.until(ExpectedConditions.presenceOfElementLocated(By.xpath(elementLocator)));
	    }
	*/
